...
pub struct CollectionPrunePath<Value, Children, InnerIter, F>
where
...
impl<Value, Children, InnerIter, F> CollectionPrunePath<Value, Children, InnerIter, F>
where
    InnerIter: TreeCollectionIterator<Value, Children>,
    F: FnMut(&[usize], &Value) -> bool,
{
...
impl<Value, Children, InnerIter, F> Iterator for CollectionPrunePath<Value, Children, InnerIter, F>
where
    InnerIter: TreeCollectionIterator<Value, Children>,
    F: FnMut(&[usize], &Value) -> bool,
{
...
impl<Value, Children, InnerIter, F> TreeCollectionIteratorBase<Value, Children>
    for CollectionPrunePath<Value, Children, InnerIter, F>
where
    InnerIter: TreeCollectionIterator<Value, Children>,
    F: FnMut(&[usize], &Value) -> bool,
{
...
pub struct BinaryCollectionPrunePath<Value, Children, InnerIter, F>
where
...
impl<Value, Children, InnerIter, F> BinaryCollectionPrunePath<Value, Children, InnerIter, F>
where
    InnerIter: BinaryTreeCollectionIterator<Value, Children>,
    F: FnMut(&[usize], &Value) -> bool,
{
...
impl<Value, Children, InnerIter, F> Iterator
    for BinaryCollectionPrunePath<Value, Children, InnerIter, F>
where
    InnerIter: BinaryTreeCollectionIterator<Value, Children>,
    F: FnMut(&[usize], &Value) -> bool,
{
