    ...
    Self: Sized,
{
    ...
    ///     result);
    /// ```
    fn map_tree<F, Output>(self, f: F) -> CollectionMap<Value, Children, Self, F, Output>
    where
    ...
    Self: Sized,
{
    ...
    ///     result);
    /// ```
    fn collect_trees(mut self) -> Vec<Tree<Value>> {
    ...
    Self: Sized,
{
    ...
    ///     result);
    /// ```
    fn collect_trees(mut self) -> Vec<BinaryTree<Value>> {
